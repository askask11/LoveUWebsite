    ...
    var modules = {
        ...
        render: function (text) {
            if (text.constructor === Array) {
                ...
                dialog.innerText = "Something wrong with the input, sorry X_X";
            }
    ...
    var action = {
        ...
        welcome: function () {
            if (document.referrer !== "" && document.referrer.indexOf(current.root) === -1) {
                ...
                if (hour > 22 || hour <= 5) {
                    text = 'Are you a night cat？这么晚还不睡觉，明天起的来嘛';
                ...
                modules.render(prop.content.welcome || "Welcome to my website！");
            }
        },
        // 触摸
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["What are you doing?", "Hey, what do you want?", "HENTAI!", "不可以这样欺负我啦！"]);
            };
        },
        // 右侧按钮
        buttons: function () {
            ...
            elements.home.onmouseover = function () {
                modules.render(prop.content.home || "Click to return main page！");
            };
            ...
            if (prop.night) {
                ...
                elements.night.onmouseover = function () {
                    modules.render("This function is temporarily unavailable.");
                };
